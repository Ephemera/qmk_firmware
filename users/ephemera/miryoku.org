...
- [[#subset-mapping][Subset Mapping]]
  - [[#userspace][Userspace]]
    - [[#usersmanna-harbour_miryokurulesmk][users/ephemera/rules.mk]]
    - [[#usersmanna-harbour_miryokuconfigh][users/ephemera/config.h]]
    - [[#usersmanna-harbour_miryokumanna-harbour_miryokuh][users/ephemera/ephemera.h]]
    - [[#usersmanna-harbour_miryokumanna-harbour_miryokuc][users/ephemera/ephemera.c]]
  - [[#layouts][Layouts]]
    - [[#60_ansi][60_ansi]]
    - [[#ergodox][ergodox]]
...
#+BEGIN_SRC python :var alphas_table=colemakdh :var thumbs_table=thumbs :var hold_table=hold :var symbol_names_table=symbol-names :var mods_table=mods :var nonkc_table=nonkc :var alpha="" :tangle no :results verbatim
width = 19
...
for tap_row, hold_row in zip(alphas_table + thumbs_table, hold_table):
  ...
  for tap, hold in zip(tap_row, hold_row):
    ...
    if not str(code).startswith(nonkc_tuple):
      code = 'KC_' + str(code)
      if code == 'KC_V' and alpha == 'colemakdh':
        code = 'TD(V_QWRT)'
      elif code == 'KC_B' and alpha == 'qwerty':
        code = 'TD(V_QWRT)'
...
:     U_NP,              U_NP,              LT(MEDIA, KC_ESC), LT(NAV, KC_TAB),   LT(MOUSE, KC_SPC), LT(SYM, KC_ENT),   LT(NUM, KC_BSPC),  LT(FUN, KC_DEL),   U_NP,              U_NP
...
mods_dict = dict.fromkeys(mods_table[0])
results = 'enum layers { BASE, QWERTY, MBO, '
...
*** [[./rules.mk][users/ephemera/rules.mk]]
...
*** [[./config.h][users/ephemera/config.h]]
...
*** [[./manna-harbour_miryoku.h][users/ephemera/ephemera.h]]

Keymap-related definitions.  Included from ~ephemera.c~.  Can be
included from keymap or layout ~keymap.c~ if needed.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ephemera.h
// <<header>>
...
*** [[./manna-harbour_miryoku.c][users/ephemera/ephemera.c]]

Contains the keymap.  Added from ~rules.mk~.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ephemera.c
// <<header>>
...
<<table-layout-taphold(alphas_table=qwerty)>>
  #else
<<table-layout-taphold(alphas_table=colemakdh, alpha="colemakdh")>>
  #endif
  ),
  [QWERTY] = LAYOUT_miryoku(
  <<table-layout-taphold(alphas_table=qwerty, alpha="qwerty")>>
  ),
...
#+BEGIN_SRC sh :tangle no
make planck/rev6:ephemera:flash FORCE_LAYOUT=planck_mit # planck_mit
make planck/rev6:ephemera:flash FORCE_LAYOUT=ortho_4x12 # ortho_4x12
#+END_SRC
...
**** [[../../layouts/community/60_ansi/ephemera/config.h][layouts/community/60_ansi/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/60_ansi/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../layouts/community/60_ansi/manna-harbour_ miryoku/keymap.c][layouts/community/60_ansi/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/60_ansi/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make ergodox_ez:ephemera:flash
#+END_SRC


**** [[../../layouts/community/ergodox/ephemera/config.h][layouts/community/ergodox/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/ergodox/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../layouts/community/ergodox/ephemera/keymap.c][layouts/community/ergodox/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/ergodox/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make marksard/rhymestone:ephemera:flash
#+END_SRC


**** [[../../layouts/community/ortho_4x10/ephemera/config.h][layouts/community/ortho_4x10/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/ortho_4x10/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../layouts/community/ortho_4x10/ephemera/keymap.c][layouts/community/ortho_4x10/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/ortho_4x10/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make planck/rev6:ephemera:flash FORCE_LAYOUT=ortho_4x12 # planck, ortho_4x12
make planck/rev6:ephemera:flash FORCE_LAYOUT=ortho_4x12 MIRYOKU_MAPPING=EXTENDED_THUMBS # planck, ortho_4x12, extended thumbs
make keebio/levinson:ephemera:flash MIRYOKU_MAPPING=SPLIT # levinson
make keebio/levinson:ephemera:flash MIRYOKU_MAPPING=EXTENDED_THUMBS # levinson, extended thumbs
#+END_SRC


**** [[../../layouts/community/ortho_4x12/ephemera/config.h][layouts/community/ortho_4x12/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/ortho_4x12/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../layouts/community/ortho_4x12/ephemera/keymap.c][layouts/community/ortho_4x12/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/ortho_4x12/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make preonic/rev3:ephemera:flash # preonic/rev3
make preonic/rev3:ephemera:flash MIRYOKU_MAPPING=EXTENDED_THUMBS # preonic/rev3, extended thumbs
make keebio/nyquist/rev3:ephemera:flash MIRYOKU_MAPPING=SPLIT # nyquist/rev3, split
make keebio/nyquist/rev3:ephemera:flash MIRYOKU_MAPPING=EXTENDED_THUMBS # nyquist/rev3, extended thumbs

#+END_SRC


**** [[../../layouts/community/ortho_5x12/ephemera/config.h][layouts/community/ortho_5x12/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/ortho_5x12/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../layouts/community/ortho_5x12/ephemera/keymap.c][layouts/community/ortho_5x12/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/ortho_5x12/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make idobo:ephemera:flash
make idobo:ephemera:flash MIRYOKU_MAPPING=EXTENDED_THUMBS # extended thumb position
#+END_SRC


**** [[../../layouts/community/ortho_5x15/ephemera/config.h][layouts/community/ortho_5x15/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/ortho_5x15/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../layouts/community/ortho_5x15/ephemera/keymap.c][layouts/community/ortho_5x15/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/ortho_5x15/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make planck/ez:ephemera:flash # planck ez
make planck/rev6:ephemera:flash FORCE_LAYOUT=planck_mit # planck rev6, mit

#+END_SRC

**** [[../../layouts/community/planck_mit/ephemera/config.h][layouts/community/planck_mit/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/planck_mit/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../layouts/community/planck_mit/ephemera/keymap.c][layouts/community/planck_mit/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/planck_mit/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make minidox:ephemera:flash
#+END_SRC


**** [[../../layouts/community/split_3x5_3/ephemera/config.h][layouts/community/split_3x5_3/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/split_3x5_3/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../layouts/community/split_3x5_3/ephemera/keymap.c][layouts/community/split_3x5_3/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/split_3x5_3/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make crkbd:ephemera:flash
#+END_SRC


**** [[../../layouts/community/split_3x6_3/ephemera/config.h][layouts/community/split_3x6_3/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/split_3x6_3/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../layouts/community/split_3x6_3/ephemera/keymap.c][layouts/community/split_3x6_3/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../layouts/community/split_3x6_3/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make atreus:ephemera:flash
#+END_SRC


**** [[../../keyboards/atreus/keymaps/ephemera/config.h][keyboards/atreus/keymaps/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/atreus/keymaps/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../keyboards/atreus/keymaps/ephemera/keymap.c][keyboards/atreus/keymaps/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/atreus/keymaps/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make ergotravel:ephemera:flash
#+END_SRC


**** [[../../keyboards/ergotravel/keymaps/ephemera/config.h][keyboards/ergotravel/keymaps/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/ergotravel/keymaps/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../keyboards/ergotravel/keymaps/ephemera/keymap.c][keyboards/ergotravel/keymaps/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/ergotravel/keymaps/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make for_science:ephemera:flash
#+END_SRC


**** [[../../keyboards/for_science/keymaps/ephemera/config.h][keyboards/for_science/keymaps/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/for_science/keymaps/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../keyboards/for_science/keymaps/ephemera/keymap.c][keyboards/for_science/keymaps/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/for_science/keymaps/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make gergo:ephemera:flash
#+END_SRC


**** [[../../keyboards/gergo/keymaps/ephemera/config.h][keyboards/gergo/keymaps/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/gergo/keymaps/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../keyboards/gergo/keymaps/ephemera/keymap.c][keyboards/gergo/keymaps/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/gergo/keymaps/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make handwired/dactyl_manuform/4x5:ephemera:flash
#+END_SRC


**** [[../../keyboards/handwired/dactyl_manuform/4x5/keymaps/ephemera/config.h][keyboards/handwired/dactyl_manuform/4x5/keymaps/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/handwired/dactyl_manuform/4x5/keymaps/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../keyboards/handwired/dactyl_manuform/4x5/keymaps/ephemera/keymap.c][keyboards/handwired/dactyl_manuform/4x5/keymaps/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/handwired/dactyl_manuform/4x5/keymaps/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make handwired/dactyl_manuform/5x6:ephemera:flash
#+END_SRC


**** [[../../keyboards/handwired/dactyl_manuform/5x6/keymaps/ephemera/config.h][keyboards/handwired/dactyl_manuform/5x6/keymaps/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/handwired/dactyl_manuform/5x6/keymaps/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../keyboards/handwired/dactyl_manuform/5x6/keymaps/ephemera/keymap.c][keyboards/handwired/dactyl_manuform/5x6/keymaps/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/handwired/dactyl_manuform/5x6/keymaps/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make keebio/iris/rev4:ephemera:flash
#+END_SRC


**** [[../../keyboards/keebio/iris/keymaps/ephemera/config.h][keyboards/keebio/iris/keymaps/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/keebio/iris/keymaps/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../keyboards/keebio/iris/keymaps/ephemera/keymap.c][keyboards/keebio/iris/keymaps/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/keebio/iris/keymaps/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make keyboardio/atreus:ephemera:flash
#+END_SRC


**** [[../../keyboards/keyboardio/atreus/keymaps/ephemera/config.h][keyboards/keyboardio/atreus/keymaps/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/keyboardio/atreus/keymaps/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../keyboards/keyboardio/atreus/keymaps/ephemera/keymap.c][keyboards/keyboardio/atreus/keymaps/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/keyboardio/atreus/keymaps/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make kyria:ephemera:flash
make kyria:ephemera:flash MIRYOKU_MAPPING=EXTENDED_THUMBS # extended thumb position
#+END_SRC


**** [[../../keyboards/kyria/keymaps/ephemera/config.h][keyboards/kyria/keymaps/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/kyria/keymaps/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../keyboards/kyria/keymaps/ephemera/keymap.c][keyboards/kyria/keymaps/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/kyria/keymaps/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make lily58:ephemera:flash
#+END_SRC


**** [[../../keyboards/lily58/keymaps/ephemera/config.h][keyboards/lily58/keymaps/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/lily58/keymaps/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../keyboards/lily58/keymaps/ephemera/keymap.c][keyboards/lily58/keymaps/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/lily58/keymaps/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make moonlander:ephemera:flash
#+END_SRC


**** [[../../keyboards/moonlander/keymaps/ephemera/config.h][keyboards/moonlander/keymaps/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/moonlander/keymaps/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../keyboards/moonlander/keymaps/ephemera/keymap.c][keyboards/moonlander/keymaps/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/moonlander/keymaps/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make redox_w:ephemera:flash
#+END_SRC


**** [[../../keyboards/redox_w/keymaps/ephemera/config.h][keyboards/redox_w/keymaps/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/redox_w/keymaps/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../keyboards/redox_w/keymaps/ephemera/keymap.c][keyboards/redox_w/keymaps/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/redox_w/keymaps/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make sofle:ephemera:flash
#+END_SRC


**** [[../../keyboards/sofle/keymaps/ephemera/config.h][keyboards/sofle/keymaps/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/sofle/keymaps/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../keyboards/sofle/keymaps/ephemera/keymap.c][keyboards/sofle/keymaps/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/sofle/keymaps/ephemera/keymap.c
// <<header>>
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
make torn:ephemera:flash
#+END_SRC


**** [[../../keyboards/torn/keymaps/ephemera/config.h][keyboards/torn/keymaps/ephemera/config.h]]

Contains subset mapping.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/torn/keymaps/ephemera/config.h :mkdirp yes
// <<header>>
...
**** [[../../keyboards/torn/keymaps/ephemera/keymap.c][keyboards/torn/keymaps/ephemera/keymap.c]]

Required by the build system.

#+BEGIN_SRC C :main no :noweb yes :padline no :tangle ../../keyboards/torn/keymaps/ephemera/keymap.c
// <<header>>
#+END_SRC
...
~ephemera/~ directory to a new directory, and create ~rules.mk~
containing ~USER_NAME := ephemera~.  The miryoku keymap will be
